$(function () {
	...
	for (i = 0; i < a.length; i++) flag = a.eq(i).data("flag"), flag ? (n = "", $.each(e, function (e, a) {
		...
		var n = $(this).find(":selected").data("country-code"),
			o = "img/flags/" + n + ".png";
		a.css("background-size", "20px"), a.css("background-position", "10px 9px"), a.css("padding-left", "40px"), a.css("background-repeat", "no-repeat"), a.css("background-image", "url('" + o + "'"), a.show()
	}), a.eq(i).on("change", function () {
		button = $(this).closest(".btn-group").children(".btn"), def = $(this).find(":selected").data("country-code"), flagIcon = "img/flags/" + def + ".png", button.css("background-size", "20px"), button.css("background-position", "10px 9px"), button.css("padding-left", "40px"), button.css("background-repeat", "no-repeat"), button.css("background-image", "url('" + flagIcon + "'")
